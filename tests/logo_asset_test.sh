...
grep -q "import logoUrl from '../../assets/logo_new.png';" app/src/components/AppHeader.tsx
grep -q 'src={logoUrl}' app/src/components/AppHeader.tsx
! grep -q 'src="assets/logo_new.png"' app/src/components/AppHeader.tsx
