...
describe('SproutOps React UI features',()=>{
  ...
  it('always renders the active and completed video sections after loading',()=>{expect(app).toContain('<VideoSections videos={videos.videos}');expect(app).not.toContain('!videos.videos.length?');});
